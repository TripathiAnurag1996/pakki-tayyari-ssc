  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success('Neural Extraction Complete', {
        description: 'Analyzing results for expert debriefing...'
      })
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-darker border-b border-white/5 backdrop-blur-3xl px-8 h-20 flex items-center justify-between">
         <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col -space-y-1">
               <span className="text-xl font-black tracking-tighter uppercase italic">Mission: <span className="text-primary tracking-normal">Neutralization</span></span>
               <span className="text-[9px] font-black tracking-[0.4em] text-zinc-400 uppercase">Status: Live Engagement</span>
            </div>
         </div>
         ...
         <div className="flex items-center gap-12">
            <div className="flex flex-col items-center gap-1">
               ...
               <span className="text-[9px] font-black uppercase tracking-widest text-zinc-500">Temporal Remaining</span>
            </div>
            ...
            <div className="flex flex-col items-end gap-1">
               <div className="flex items-center gap-3">
                 <div className="h-1.5 w-48 bg-white/[0.03] rounded-full overflow-hidden border border-white/5">
                   <div 
                     className="h-full bg-primary shadow-[0_0_10px_rgba(99,102,241,0.5)] transition-all duration-700" 
                     style={{ width: `${progress}%` }} 
                   />
                 </div>
                 <span className="text-sm font-black text-white italic tabular-nums">{Math.round(progress)}%</span>
               </div>
               <span className="text-[9px] font-black uppercase tracking-widest text-zinc-500">Mastery Progress</span>
            </div>
         </div>
         ...
         <Button 
           ...
           className="h-12 px-8 rounded-xl font-black uppercase tracking-widest text-[11px] shadow-[0_15px_30px_rgba(99,102,241,0.3)] hover:scale-105 active:scale-95 transition-all"
         >
      ...
      <main className="pt-32 pb-20 px-8 max-w-[1400px] mx-auto grid grid-cols-12 gap-12">
        ...
        <div className="col-span-12 lg:col-span-8 space-y-8">
           ...
           <div className="flex items-center justify-between px-2">
              ...
              >
                <ChevronLeft className="mr-2 h-5 w-5" /> Vector Prev
              </Button>
              ...
              {currentIndex === initialQuestions.length - 1 ? (
                ...
                >
                  Extraction Ready <Target className="ml-2 h-5 w-5" />
                </Button>
              ) : (
                <Button
                  size="lg"
                ...
                >
                  Vector Next <ChevronRight className="ml-2 h-5 w-5" />
                </Button>
              )}
           </div>
        </div>
        ...
        <div className="hidden lg:col-span-4 space-y-8">
           <div className="flex items-center gap-4 px-2">
              ...
              <h3 className="text-3xl font-black tracking-tighter text-white uppercase italic">Command Map</h3>
           </div>
           ...
           <div className="bento-card !p-10 space-y-10 border-white/5 bg-white/[0.01]">
              ...
              <div className="pt-8 border-t border-white/5 space-y-6">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <LegendItem label="Active Vector" color="bg-primary" />
                    <LegendItem label="Attempted" color="bg-emerald-500/40" />
                    <LegendItem label="Flagged" color="bg-amber-500" />
                    <LegendItem label="Neutral" color="bg-white/5" />
                 </div>
              </div>
              ...
              <div className="pt-8 border-t border-white/5 flex flex-col gap-4">
                 <div className="flex items-center gap-4 p-5 rounded-2xl bg-white/[0.02] border border-white/5">
                    ...
                    <div className="space-y-0.5">
                       <p className="text-xs font-black text-white uppercase tracking-widest">Neural Tip</p>
                       <p className="text-[10px] text-zinc-500 font-bold leading-tight">Don&apos;t linger on flagged vectors. Initialize completion and return during final sweep.</p>
                    </div>
                 </div>
              </div>
           </div>
