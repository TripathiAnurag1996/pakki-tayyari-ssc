    ...
    <div className="flex flex-col h-full bg-[#050505] border-r border-white/[0.04] relative overflow-hidden noise">
      <div className="px-8 py-12 flex-1 relative z-10">
        <Link href="/dashboard" className="flex items-center gap-4 mb-16 px-2 group">
          ...
          <div className="flex flex-col -space-y-1">
            ...
            <span className="text-[9px] font-black tracking-[0.4em] text-zinc-600 uppercase">Neural Mastery</span>
          </div>
        </Link>

        <div className="space-y-3">
          <div className="px-4 mb-6">
            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-700">Operational Grid</span>
          </div>
        ...
        <div className="mt-16 p-8 rounded-3xl bg-gradient-to-br from-primary/[0.05] to-transparent border border-white/[0.05] relative overflow-hidden group shadow-2xl">
           <div className="relative z-10 space-y-4">
              <div className="flex items-center gap-3">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Neural Level 12</span>
              </div>
              <div className="text-3xl font-black text-white italic tracking-tighter">CENTURION</div>
              ...
              <p className="text-[9px] font-black text-zinc-600 leading-tight uppercase tracking-widest">Target: Level 13 (+24 vectors required)</p>
           </div>
      ...
      <div className="p-8 border-t border-white/[0.04] space-y-4 relative z-10">
        ...
        >
          ...
          <span className="text-xs font-black uppercase tracking-widest">System Prefs</span>
        </Link>
        ...
        <form action={signout}>
          ...
          >
            ...
            <span className="text-xs font-black uppercase tracking-widest">Kill Session</span>
          </button>
        </form>
      </div>
    </div>
