    ...
    <div className="min-h-screen bg-[#020202] text-white overflow-x-hidden selection:bg-primary/30 selection:text-primary relative font-sans noise">
      ...
      <nav className="fixed top-8 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl z-50 glass rounded-3xl py-4 px-8 flex items-center justify-between border-white/5 shadow-2xl backdrop-blur-3xl">
        <div className="flex items-center gap-4 group cursor-pointer">
          ...
          <div className="flex flex-col -space-y-1">
            ...
            <span className="text-[10px] font-black tracking-[0.3em] text-zinc-500 uppercase">Neural Mastery</span>
          </div>
        </div>
        ...
        <section className="relative px-6 mb-32">
          <div className="max-w-7xl mx-auto text-center space-y-12 animate-in-fade">
            ...
            <h1 className="text-8xl md:text-[140px] font-black tracking-tighter leading-[0.8] text-white">
              Surgical <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/20">Mastery.</span>
            </h1>
            
            <p className="max-w-2xl mx-auto text-xl md:text-2xl text-zinc-400 font-medium leading-relaxed tracking-tight">
              A high-precision cognitive environment for UPSC & SSC aspirants. Master every subject with the precision of a neural network.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8">
              <Link href="/login">
                <Button size="lg" className="h-20 px-16 rounded-[2rem] text-2xl font-black shadow-[0_20px_50px_rgba(99,102,241,0.4)] hover:scale-105 active:scale-95 transition-all group">
                  Enter The Sanctum <ChevronRight className="ml-2 h-8 w-8 transition-transform group-hover:translate-x-2" />
                </Button>
              </Link>
              <div className="flex flex-col items-start gap-1">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-widest text-zinc-600 ml-1">Trusted by Elite Aspirants</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
             <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
                <div className="space-y-4">
                   <div className="badge-tactical">Functional Architecture</div>
                   <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-white">The Neural <span className="text-primary italic">Interface.</span></h2>
                </div>
                <p className="text-zinc-500 font-medium max-w-sm text-right">
                  Engineered to eliminate cognitive load and focus purely on the acquisition of mastery.
                </p>
             </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 auto-rows-[340px]">
              <div className="md:col-span-8 bento-card group flex flex-col justify-end">
                ...
                <div className="space-y-4 relative z-10">
                   <h3 className="text-4xl font-black text-white tracking-tighter">Adaptive Cognitive Shifting</h3>
                   <p className="text-zinc-400 text-xl font-medium leading-relaxed max-w-xl">
                    Real-time difficulty recalibration based on neural feedback. Stay in the zone of proximal development, always.
                   </p>
                </div>
              ...
              <div className="md:col-span-4 bento-card group bg-gradient-to-br from-emerald-500/[0.02] to-transparent">
                ...
                <h3 className="text-3xl font-black text-white mb-4 tracking-tighter">Surgical Data</h3>
                <p className="text-zinc-500 text-lg font-medium leading-tight">
                  Deconstruct your performance down to individual sub-topics and cognitive blind spots.
                </p>
              </div>
              ...
              <div className="md:col-span-8 bento-card group flex flex-col items-center justify-center text-center overflow-hidden">
                <div className="relative z-10 space-y-6">
                   ...
                   <div className="text-sm font-black uppercase tracking-[0.5em] text-primary">Mastery Conversion Rate</div>
        ...
        <section id="methodology" className="py-40 px-6 relative">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-32 items-center">
            <div className="space-y-12">
              <div className="badge-tactical">Operational Philosophy</div>
              ...
              <p className="text-2xl text-zinc-400 font-medium leading-relaxed tracking-tight">
                Traditional studying is passive. Pakki Tayyari is surgical. We utilize active recall and spaced repetition embedded in a tactical interface.
              </p>
              <div className="space-y-6 pt-4">
                <TacticalFeature icon={<ShieldCheck />} title="Sovereign Data Control" desc="Your progress is encrypted and synchronized across the neural cloud." />
                <TacticalFeature icon={<Target />} title="Targeted Hardening" desc="Automatically identifies and forces drills on your weakest cognitive links." />
                <TacticalFeature icon={<Fingerprint />} title="Personalized Vectoring" desc="AI-driven curriculum pathing that adapts to your unique learning velocity." />
              </div>
            </div>
        ...
        <section className="py-40 px-6">
           <div className="max-w-6xl mx-auto glass p-32 rounded-[5rem] text-center space-y-12 border-white/5 shadow-[0_0_120px_rgba(99,102,241,0.1)] relative overflow-hidden group">
              ...
              <p className="text-2xl md:text-3xl text-zinc-400 font-medium max-w-2xl mx-auto relative z-10 tracking-tight">
                The most advanced exam mastery environment ever built. Are you ready to initialize?
              </p>
      ...
      <footer className="py-24 px-8 border-t border-white/5 relative z-10 bg-[#020202]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-16">
          <div className="col-span-2 space-y-8">
            ...
            <p className="text-zinc-500 font-medium max-w-sm text-lg leading-relaxed">
              Redefining competitive exam preparation through neural-adaptive technology and surgical data precision.
            </p>
          </div>
          <div className="space-y-6">
             <h4 className="text-xs font-black uppercase tracking-[0.3em] text-white">Architecture</h4>
             <ul className="space-y-4 text-zinc-500 font-bold text-sm uppercase tracking-widest">
                <li><Link href="#" className="hover:text-primary transition-colors">Cognitive Engine</Link></li>
                <li><Link href="#" className="hover:text-primary transition-colors">Temporal Drills</Link></li>
                <li><Link href="#" className="hover:text-primary transition-colors">Surgical Data</Link></li>
             </ul>
          </div>
          <div className="space-y-6">
             ...
             <ul className="space-y-4 text-zinc-500 font-bold text-sm uppercase tracking-widest">
                ...
                <li><Link href="#" className="hover:text-primary transition-colors">Intelligence Contact</Link></li>
             </ul>
          </div>
        </div>
        <div className="max-w-7xl mx-auto mt-24 pt-8 border-t border-white/5 flex items-center justify-between text-[10px] font-black uppercase tracking-[0.5em] text-zinc-700">
           <span>&copy; 2026 Pakki Tayyari Neural Systems</span>
