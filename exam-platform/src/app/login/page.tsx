         ...
         <div className="flex flex-col items-center mb-16 space-y-6">
            ...
            <div className="text-center space-y-2">
               ...
               <div className="flex items-center gap-3 justify-center">
                  <span className="text-[10px] font-black tracking-[0.4em] text-zinc-400 uppercase">SSC Practice Portal</span>
               ...
               <div className="space-y-6">
                  <div className="space-y-3">
                     ...
                     <div className="relative group/input">
                        ...
                        />
                        <Mail className="absolute right-6 top-1/2 -translate-y-1/2 h-5 w-5 text-zinc-500 group-focus-within/input:text-primary transition-colors" />
                     </div>
                  </div>
                  ...
                  <div className="space-y-3">
                     ...
                     <div className="relative group/input">
                        <Input
                          ...
                          className="h-16 bg-white/[0.04] border-white/10 rounded-2xl px-6 text-lg font-bold focus:border-primary focus:ring-0 transition-all placeholder:text-zinc-500 text-white"
                        />
                        <Lock className="absolute right-6 top-1/2 -translate-y-1/2 h-5 w-5 text-zinc-500 group-focus-within/input:text-primary transition-colors" />
                     </div>
                  </div>
               </div>
