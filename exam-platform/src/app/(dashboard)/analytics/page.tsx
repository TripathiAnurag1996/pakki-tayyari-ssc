      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
        <div className="space-y-6">
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-primary/5 border border-primary/10 text-primary text-[10px] font-black uppercase tracking-[0.4em] shadow-inner backdrop-blur-xl">
             <div className="h-1.5 w-1.5 rounded-full bg-primary animate-pulse" /> Performance Analytics
          </div>
          <div className="space-y-2">
            ...
            <p className="text-zinc-500 text-xl font-medium tracking-tight max-w-xl">Detailed insights into your subject proficiency and preparation progress.</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
           <Button className="h-14 px-10 rounded-2xl font-black uppercase tracking-widest text-[11px] shadow-[0_15px_30px_rgba(99,102,241,0.3)] group transition-all">
              View Full Report <ChevronRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
           </Button>
        </div>
      </div>
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 space-y-8">
           <div className="flex items-center gap-4 px-2">
              ...
              <h3 className="text-3xl font-black tracking-tighter text-white uppercase italic">Subject Proficiency</h3>
           </div>
              ...
              <div className="space-y-10">
                 {analyzedSubjects.length > 0 ? analyzedSubjects.map(sub => (
                     ...
                     <div className="flex justify-between items-end">
                       <div className="space-y-1">
                         ...
                         <div className="flex items-center gap-3 text-[10px] font-black text-zinc-500 uppercase tracking-widest">
                            <span>{sub.count} Practice Sessions</span>
                   ...
                   <div className="text-center py-20 opacity-30">
                     <p className="text-zinc-500 font-black uppercase tracking-[0.4em] text-sm">Not Enough Data for Analysis</p>
                   </div>
                 )}
              </div>
           </div>
        ...
        <div className="lg:col-span-5 space-y-8">
           <div className="flex items-center gap-4 px-2">
              ...
              <h3 className="text-3xl font-black tracking-tighter text-white uppercase italic">Expert Insights</h3>
           </div>

           <div className="space-y-6">
              <StrategyItem 
                title="Focus Areas" 
                desc="Your accuracy in Mathematics has dropped recently. We recommend practicing a set of 20 questions to improve."
                color="bg-sky-500"
                icon={<Target className="h-5 w-5 text-sky-500" />}
              />
              <StrategyItem 
                title="Time Management" 
                desc="Analysis shows you spend more time on difficult questions. Try speed-drills to improve your response time."
                color="bg-violet-500"
                icon={<Zap className="h-5 w-5 text-violet-500" />}
              />
              <StrategyItem 
                title="Preparation Milestone" 
                desc="Maintain your current pace for 3 more days to unlock full-length mock tests."
