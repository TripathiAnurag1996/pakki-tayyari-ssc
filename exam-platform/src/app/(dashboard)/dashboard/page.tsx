    ...
    <div className="space-y-12 animate-in-fade pb-20">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
        <div className="space-y-6">
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-white/[0.03] border border-white/5 text-[10px] font-black uppercase tracking-[0.4em] text-primary shadow-inner">
             <div className="h-1.5 w-1.5 rounded-full bg-primary animate-pulse" /> System Status: Online
          </div>
          <div className="space-y-2">
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-white leading-none">
              Welcome, <br />
              <span className="text-primary italic">Student.</span>
            </h2>
            <p className="text-zinc-500 text-xl font-medium tracking-tight">Your overall accuracy is at <span className="text-emerald-400 font-black">94%</span> today.</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
           <Link href="/practice">
             <Button size="xl" variant="shimmer" className="shadow-[0_20px_40px_rgba(99,102,241,0.3)] hover:scale-105 active:scale-95 transition-all group font-black uppercase tracking-widest italic">
               Start Practice <BookOpen className="ml-2 h-6 w-6 fill-current transition-transform group-hover:rotate-12" />
             </Button>
          </Link>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <MasteryStat 
          ...
          icon={<StatsIcon className="h-6 w-6 text-emerald-400" />}
          trend="Top 4% of Students"
        />
        <MasteryStat 
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        ...
        <div className="lg:col-span-8 space-y-8">
           <div className="flex items-center justify-between px-2">
              <div className="flex items-center gap-4">
                 ...
                 <h3 className="text-3xl font-black tracking-tighter text-white">Practice History</h3>
              </div>
              <Link href="/history">
                  ...
                  <div className="group bento-card !p-8 flex items-center justify-between hover:bg-white/[0.04] border-white/[0.02] transition-all duration-500">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="space-y-1">
                        <p className="text-2xl font-black text-white tracking-tighter group-hover:text-primary transition-colors">
                           {session.subject || 'Full Mock Test'}
                        </p>
                    ...
                    <div className="flex flex-col items-end gap-1">
                       <div className="text-3xl font-black text-white tabular-nums tracking-tighter italic">
                        ...
                        <div className="badge-tactical !py-0.5 !px-2 !text-[9px]">{session.status === 'completed' ? 'Practice Complete' : 'In Progress'}</div>
                    </div>
                  </div>
                </Link>
              )) : (
                <div className="bento-card text-center py-24 border-dashed border-white/5 opacity-50">
                  <p className="text-zinc-500 font-black uppercase tracking-[0.4em] text-xs">No Practice History Found</p>
                </div>
              )}
           </div>
        </div>
        ...
        <div className="lg:col-span-4 space-y-8">
           <h3 className="text-3xl font-black tracking-tighter text-white">Performance Insights</h3>
           <div className="bento-card bg-gradient-to-br from-primary/[0.03] to-transparent border-primary/10 p-10 space-y-10">
              <div className="space-y-6">
                 <div className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500">Subject Strength</div>
                 <div className="space-y-6">
              ...
              <div className="pt-8 border-t border-white/5 relative">
                  <div className="absolute -top-3 left-6 px-3 py-0.5 bg-[#0a0a0a] border border-white/5 rounded-full text-[9px] font-black uppercase tracking-widest text-primary">Expert Tip</div>
                 <p className="text-lg text-zinc-400 font-medium leading-relaxed italic tracking-tight">
                   &quot;Your response speed on &apos;Hard&apos; questions is improving. Focused practice on Quantitative Aptitude will help you score better.&quot;
                 </p>
              </div>

              <Button className="w-full h-14 rounded-2xl font-black uppercase tracking-widest text-[11px] group">
                 View Performance Report <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-2" />
              </Button>
           </div>
        </div>
      </div>
